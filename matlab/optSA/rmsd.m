function [minDist]=rmsd(c1,c2)
    ...
    minDist=Inf; %Initialize with output for finding min rmsd
    sameTol=1e-7; gapTol=1; %Tolerances
    ...
    %Sort these lists of distances. 
    [sd1,I1]=sort(d1); [~,I2]=sort(d2);
    sp1=p1(I1,:); sp2=p2(I2,:);
